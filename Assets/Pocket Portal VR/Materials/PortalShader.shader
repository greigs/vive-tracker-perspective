Shader "Portals/PortalShader"
{
	Properties
	{
	 ...
	 _MyVector ("MyVector2", Vector) = (0,0,0,0)
	...
	SubShader {
		...
		Pass {
			...
			vertexOutput vert(vertexInput v) {
				...
				//v.vertex1.x += _MyVector.x;
				float4 tmp = UnityObjectToClipPos(v.vertex1);

				float2 uv = (o.pos.xy / o.pos.w) * 0.5f + 1;
				o.screenPos = float4(uv, 0, 1);
				//o.screenPos = (o.pos.xy / o.pos.w) * 0.5f + 1;
				o.screenPos =  ComputeScreenPos(tmp);
