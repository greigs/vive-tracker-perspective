...
public class PerspectiveCam : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        var verticeList = new List<Vector3>(meshFilter.mesh.vertices);
        pa = meshFilter.transform.TransformPoint(verticeList[0]);
        pb = meshFilter.transform.TransformPoint(verticeList[10]);
        pc = meshFilter.transform.TransformPoint(verticeList[110]);
        pd = meshFilter.transform.TransformPoint(verticeList[120]);
